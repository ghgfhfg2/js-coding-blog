(function () {
  ...
  function renderArchiveSummary() {
    ...
    if (items.length === 0) {
      ...
      archiveSolvedCount.textContent = '0';
      archiveLastTitle.textContent = '없음';
      archiveLastDate.textContent = '-';
      archiveSummaryCopy.textContent = '아직 기록된 풀이가 없습니다. 문제를 하나 풀어보세요.';
      if (recentSolvedList) recentSolvedList.innerHTML = '';
      return;
    }
